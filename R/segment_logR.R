#' Segment log ratio values with DNACopy
#' @description The function takes tumor logR file generated by \code{\link{prep_ascat}} and performs segmentation with \code{\link{DNAcopy}}
#' @param tumor_logR sample.tumour.logR.txt file generated by \code{\link{prep_ascat}}
#' @param sample_name Default "tumor"
#' @return Invisibly returns \code{\link{DNAcopy}} object
#' @export
#' @import DNAcopy
segment_logR = function(tumor_logR = NULL, sample_name = "tumor"){
  ...
  cn = DNAcopy::segment(cn, alpha = 0.01, nperm = 10000, p.method = 'hybrid', min.width = 5, kmax = 25, nmin = 210,
                        eta = 0.05, trim = 0.025, undo.SD = 3, undo.prune = 0.05, undo.splits = 'prune')
